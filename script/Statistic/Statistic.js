document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelector('.MenuStatistica').classList.add('active');
});

document.addEventListener('DOMContentLoaded', () => {
  const profileButtons = document.querySelectorAll('.toProfile');
  profileButtons.forEach((btn) => {
    btn.addEventListener('click', () => {
      window.location.href = '/pages/Statistic/StatisticProfil.html';
    });
  });
});
